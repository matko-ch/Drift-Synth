...
const std::vector<Preset>& getFactoryPresets() {
    static const std::vector<Preset> bank = {
        ...
        // ══ KEYS (rich, playable) ════════════════════════════════════════════════
        { "DX Electric Piano", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 2 }, { P::OSC_FM, 0.4f }, { P::OSC_MIX, 0.25f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 4500.0f }, { P::FILT1_ENV_AMT, 0.2f }, { P::FILT1_KEYTRACK, 0.5f },
            { P::FILTENV_D, 0.4f }, { P::FILTENV_S, 0.1f },
            { P::AMPENV_A, 0.002f }, { P::AMPENV_D, 1.0f }, { P::AMPENV_S, 0.25f }, { P::AMPENV_R, 0.5f }, { P::AMPENV_CURVE, 0.8f },
            { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.3f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.25f }, { P::DRIFT_AMOUNT, 0.2f },
        }},
        { "Wurli Bite", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_FM, 0.35f }, { P::OSC_MIX, 0.3f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 3200.0f }, { P::FILT1_ENV_AMT, 0.35f },
            { P::FILTENV_A, 0.001f }, { P::FILTENV_D, 0.25f }, { P::FILTENV_S, 0.1f },
            { P::AMPENV_A, 0.002f }, { P::AMPENV_D, 0.8f }, { P::AMPENV_S, 0.3f }, { P::AMPENV_R, 0.4f },
            { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.2f }, { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.25f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.2f },
        }},
        { "Glass Celeste", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_SEMITONE, 12 }, { P::OSC_FM, 0.25f }, { P::OSC_MIX, 0.3f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 6000.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 1.2f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.8f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.3f }, { P::DELAY_MIX, 0.25f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f }, { P::REVERB_SIZE, 0.85f }, { P::VIBE_AIR, 0.4f },
        }},
        { "Clav Funk", "Keys", {
            { P::OSC1_SHAPE, 3 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, 4.0f }, { P::OSC_MIX, 0.35f },
            { P::FILT1_TYPE, 2 }, { P::FILT1_CUTOFF, 2400.0f }, { P::FILT1_RES, 0.35f }, { P::FILT1_ENV_AMT, 0.4f },
            { P::FILTENV_A, 0.001f }, { P::FILTENV_D, 0.18f }, { P::FILTENV_S, 0.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.4f }, { P::AMPENV_S, 0.2f }, { P::AMPENV_R, 0.2f },
            { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.3f }, { P::PHASER_ON, 1 }, { P::PHASER_RATE, 1.0f }, { P::PHASER_MIX, 0.3f },
        }},
        { "Soft Felt Keys", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 1 }, { P::OSC2_FINE, 3.0f }, { P::OSC_MIX, 0.35f },
            { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 2000.0f }, { P::FILT1_RES, 0.08f },
            { P::AMPENV_A, 0.01f }, { P::AMPENV_D, 1.0f }, { P::AMPENV_S, 0.2f }, { P::AMPENV_R, 0.7f },
            { P::DRIFT_AMOUNT, 0.3f }, { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.3f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.35f }, { P::EQ_ON, 1 }, { P::EQ_HIGH, -3.0f }, { P::VIBE_WARM, 0.4f },
        }},
        { "Bell Tine Keys", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_SEMITONE, 7 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_FM, 0.3f },
            { P::OSC_MIX, 0.3f }, { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 5000.0f }, { P::FILT1_KEYTRACK, 0.4f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 1.4f }, { P::AMPENV_S, 0.15f }, { P::AMPENV_R, 0.6f },
            { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.25f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.3f },
        }},

        // ══ PADS ═════════════════════════════════════════════════════════════════
        { "Aurora Pad", "Pad", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, 9.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 5 }, { P::UNISON_DETUNE, 0.35f }, { P::UNISON_SPREAD, 1.0f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 2400.0f }, { P::FILT1_RES, 0.1f }, { P::FILT1_ENV_AMT, 0.2f },
            { P::AMPENV_A, 1.2f }, { P::AMPENV_D, 1.0f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 3.0f },
            { P::DRIFT_AMOUNT, 0.5f }, { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.4f },
            { P::PHASER_ON, 1 }, { P::PHASER_RATE, 0.15f }, { P::PHASER_MIX, 0.35f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.5f }, { P::REVERB_SIZE, 0.95f }, { P::VIBE_AIR, 0.4f }, { P::VIBE_DREAM, 0.4f },
        }},
        { "Velvet Warm Pad", "Pad", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 1 }, { P::OSC2_OCTAVE, -1 }, { P::OSC_MIX, 0.45f },
            { P::UNISON_VOICES, 4 }, { P::UNISON_DETUNE, 0.28f },
            { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 1400.0f }, { P::FILT1_RES, 0.12f },
            { P::AMPENV_A, 0.8f }, { P::AMPENV_D, 1.0f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 2.5f },
            { P::DRIFT_AMOUNT, 0.6f }, { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.4f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.45f }, { P::REVERB_SIZE, 0.9f }, { P::VIBE_WARM, 0.5f },
        }},
        { "Evolving Motion Pad", "Pad", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 4 }, { P::OSC2_PW, 0.4f }, { P::OSC2_FINE, 6.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 4 }, { P::UNISON_DETUNE, 0.35f },
            { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 1600.0f }, { P::FILT1_RES, 0.2f },
            { P::AMPENV_A, 1.0f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 3.0f },
            { P::LFO1_RATE, 0.3f }, { P::ORBIT_MOTION, 0.6f }, { P::ORBIT_SPACE, 0.5f }, { P::VIBE_MOVE, 0.5f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.5f }, { P::REVERB_SIZE, 1.0f },
        }},
        { "Frozen Glass Pad", "Pad", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC2_FINE, 8.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 3 }, { P::UNISON_DETUNE, 0.25f }, { P::UNISON_SPREAD, 1.0f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 3500.0f }, { P::FILT1_RES, 0.1f },
            { P::AMPENV_A, 1.5f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 3.5f },
            { P::DRIFT_AMOUNT, 0.4f }, { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.5f }, { P::DELAY_FDBK, 0.6f }, { P::DELAY_MIX, 0.3f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.55f }, { P::REVERB_SIZE, 1.0f }, { P::VIBE_AIR, 0.5f },
        }},
        { "Breathing Choir Pad", "Pad", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 4 }, { P::OSC2_PW, 0.35f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 6 }, { P::UNISON_DETUNE, 0.4f }, { P::UNISON_SPREAD, 1.0f },
            { P::FILT1_TYPE, 2 }, { P::FILT1_CUTOFF, 1500.0f }, { P::FILT1_RES, 0.4f }, { P::FILT1_ENV_AMT, 0.2f },
            { P::AMPENV_A, 1.0f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 3.0f },
            { P::LFO1_RATE, 4.5f }, { P::DRIFT_AMOUNT, 0.5f }, { P::ORBIT_MOTION, 0.4f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.55f }, { P::REVERB_SIZE, 1.0f }, { P::VIBE_DREAM, 0.5f },
        }},
        { "Sub Warmth Pad", "Pad", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, -1 }, { P::OSC_MIX, 0.4f }, { P::SUB_LEVEL, 0.3f },
            { P::UNISON_VOICES, 3 }, { P::UNISON_DETUNE, 0.25f },
            { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 1200.0f }, { P::FILT1_RES, 0.1f },
            { P::AMPENV_A, 0.6f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 2.0f },
            { P::DRIFT_AMOUNT, 0.4f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f }, { P::VIBE_WARM, 0.4f },
        }},

        // ══ LEADS ════════════════════════════════════════════════════════════════
        { "Singing Sine Lead", "Lead", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_FINE, 4.0f }, { P::OSC_MIX, 0.35f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 4500.0f },
            { P::AMPENV_A, 0.03f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 0.4f },
            { P::POLY_VOICES, 1 }, { P::GLIDE_TIME, 0.08f }, { P::LFO1_RATE, 5.0f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.33f }, { P::DELAY_MIX, 0.3f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.3f },
            { P::VIBE_MOVE, 0.3f },
        }},
        { "Hard Sync Lead", "Lead", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_SYNC, 1 }, { P::OSC2_SEMITONE, 7 }, { P::OSC_MIX, 0.6f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 3000.0f }, { P::FILT1_RES, 0.2f }, { P::FILT1_ENV_AMT, 0.3f },
            { P::AMPENV_A, 0.004f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 0.3f },
            { P::POLY_VOICES, 1 }, { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.35f },
            { P::DELAY_ON, 1 }, { P::DELAY_MIX, 0.25f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.2f },
        }},
        { "Distorted Saw Lead", "Lead", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, 7.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 3 }, { P::UNISON_DETUNE, 0.25f },
            { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 3200.0f }, { P::FILT1_RES, 0.25f }, { P::FILT1_KEYTRACK, 0.4f },
            { P::AMPENV_A, 0.004f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 0.3f },
            { P::POLY_VOICES, 1 }, { P::GLIDE_TIME, 0.04f },
            { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.55f }, { P::DELAY_ON, 1 }, { P::DELAY_MIX, 0.3f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.25f },
        }},
        { "Whistle Lead", "Lead", {
            { P::OSC1_SHAPE, 0 }, { P::OSC_MIX, 0.0f }, { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 5000.0f },
            { P::AMPENV_A, 0.05f }, { P::AMPENV_S, 0.95f }, { P::AMPENV_R, 0.3f },
            { P::POLY_VOICES, 1 }, { P::GLIDE_TIME, 0.1f }, { P::LFO1_RATE, 6.0f }, { P::VIBE_MOVE, 0.4f },
            { P::DELAY_ON, 1 }, { P::DELAY_MIX, 0.3f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.35f },
        }},
        { "Vintage PWM Lead", "Lead", {
            { P::OSC1_SHAPE, 4 }, { P::OSC1_PW, 0.3f }, { P::OSC2_SHAPE, 4 }, { P::OSC2_PW, 0.6f }, { P::OSC2_FINE, 5.0f },
            { P::OSC_MIX, 0.5f }, { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 2600.0f }, { P::FILT1_RES, 0.2f },
            { P::AMPENV_A, 0.01f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 0.3f },
            { P::POLY_VOICES, 1 }, { P::LFO1_RATE, 3.0f }, { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.4f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.25f }, { P::DRIFT_AMOUNT, 0.35f },
        }},

        // ══ BASS ═════════════════════════════════════════════════════════════════
        { "Moog Mono Bass", "Bass", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_OCTAVE, -1 }, { P::OSC_MIX, 0.4f }, { P::SUB_LEVEL, 0.3f },
            { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 600.0f }, { P::FILT1_RES, 0.35f }, { P::FILT1_ENV_AMT, 0.4f },
            { P::FILTENV_D, 0.2f }, { P::FILTENV_S, 0.2f },
            { P::AMPENV_A, 0.002f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 0.15f },
            { P::POLY_VOICES, 1 }, { P::GLIDE_TIME, 0.05f }, { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.3f }, { P::DRIFT_AMOUNT, 0.15f },
        }},
        { "FM Punch Bass", "Bass", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_FM, 0.5f }, { P::OSC_MIX, 0.3f },
            { P::SUB_LEVEL, 0.4f }, { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 900.0f }, { P::FILT1_RES, 0.2f }, { P::FILT1_ENV_AMT, 0.3f },
            { P::FILTENV_D, 0.12f }, { P::FILTENV_S, 0.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.4f }, { P::AMPENV_S, 0.6f }, { P::AMPENV_R, 0.1f },
            { P::POLY_VOICES, 1 }, { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.35f },
        }},
        { "Acid Squelch Bass", "Acid", {
            { P::OSC1_SHAPE, 2 }, { P::OSC_MIX, 0.0f }, { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 450.0f }, { P::FILT1_RES, 0.75f },
            { P::FILT1_ENV_AMT, 0.8f }, { P::FILTENV_A, 0.001f }, { P::FILTENV_D, 0.2f }, { P::FILTENV_S, 0.0f },
            { P::AMPENV_A, 0.002f }, { P::AMPENV_D, 0.3f }, { P::AMPENV_S, 0.5f }, { P::AMPENV_R, 0.1f },
            { P::POLY_VOICES, 1 }, { P::GLIDE_TIME, 0.05f }, { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.45f },
            { P::DELAY_ON, 1 }, { P::DELAY_MIX, 0.2f }, { P::DELAY_FDBK, 0.5f },
        }},
        { "Wide Reese Growl", "Bass", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, -16.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 5 }, { P::UNISON_DETUNE, 0.5f }, { P::UNISON_SPREAD, 0.5f }, { P::OSC_FM, 0.15f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 700.0f }, { P::FILT1_RES, 0.3f },
            { P::AMPENV_A, 0.004f }, { P::AMPENV_S, 0.9f }, { P::POLY_VOICES, 1 },
            { P::ORBIT_MOTION, 0.4f }, { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.4f }, { P::VIBE_GRIT, 0.3f },
        }},

        // ══ PLUCKS ═══════════════════════════════════════════════════════════════
        { "Synth Harp", "Pluck", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_MIX, 0.3f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 3500.0f }, { P::FILT1_ENV_AMT, 0.3f },
            { P::FILTENV_A, 0.001f }, { P::FILTENV_D, 0.25f }, { P::FILTENV_S, 0.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.7f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.5f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.3f }, { P::DELAY_FDBK, 0.45f }, { P::DELAY_MIX, 0.3f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.35f }, { P::VIBE_AIR, 0.35f },
        }},
        { "Mallet Dream Pluck", "Pluck", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_FM, 0.2f }, { P::OSC_MIX, 0.25f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 3000.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.5f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.4f },
            { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.3f }, { P::DELAY_ON, 1 }, { P::DELAY_MIX, 0.3f }, { P::DELAY_FDBK, 0.4f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f }, { P::VIBE_DREAM, 0.4f },
        }},
        { "Nylon Synth Pluck", "Pluck", {
            { P::OSC1_SHAPE, 1 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, 3.0f }, { P::OSC_MIX, 0.3f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 2600.0f }, { P::FILT1_ENV_AMT, 0.35f },
            { P::FILTENV_A, 0.001f }, { P::FILTENV_D, 0.2f }, { P::FILTENV_S, 0.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.5f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.3f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.3f }, { P::DRIFT_AMOUNT, 0.3f },
        }},

        // ══ CINEMATIC / STRINGS ══════════════════════════════════════════════════
        { "Epic Brass Stack", "Cinematic", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_OCTAVE, -1 }, { P::OSC2_FINE, 5.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 6 }, { P::UNISON_DETUNE, 0.35f }, { P::UNISON_SPREAD, 0.9f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 2200.0f }, { P::FILT1_RES, 0.2f }, { P::FILT1_ENV_AMT, 0.4f },
            { P::FILTENV_A, 0.05f }, { P::FILTENV_D, 0.5f }, { P::FILTENV_S, 0.5f },
            { P::AMPENV_A, 0.05f }, { P::AMPENV_D, 0.6f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 0.6f },
            { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.25f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.35f }, { P::EQ_ON, 1 }, { P::EQ_LOW, 2.0f },
        }},
        { "Soft String Ensemble", "Strings", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, 7.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 6 }, { P::UNISON_DETUNE, 0.3f }, { P::UNISON_SPREAD, 0.9f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 1800.0f }, { P::FILT1_RES, 0.08f },
            { P::AMPENV_A, 0.6f }, { P::AMPENV_D, 0.8f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 1.5f },
            { P::DRIFT_AMOUNT, 0.4f }, { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.45f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f }, { P::VIBE_WARM, 0.3f }, { P::VIBE_WIDE, 0.4f },
        }},
        { "Tension Riser Pad", "Cinematic", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 3 }, { P::OSC2_FINE, 20.0f }, { P::OSC_MIX, 0.5f }, { P::OSC_NOISE, 0.08f },
            { P::UNISON_VOICES, 5 }, { P::UNISON_DETUNE, 0.5f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 1000.0f }, { P::FILT1_RES, 0.3f }, { P::FILT1_ENV_AMT, 0.7f },
            { P::FILTENV_A, 3.0f }, { P::FILTENV_S, 1.0f },
            { P::AMPENV_A, 2.0f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 1.0f },
            { P::ORBIT_MOTION, 0.5f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.5f }, { P::REVERB_SIZE, 1.0f },
        }},

        // ══ EXPERIMENTAL II ══════════════════════════════════════════════════════
        { "Alien Vox Texture", "Experimental", {
            { P::OSC1_SHAPE, 4 }, { P::OSC1_PW, 0.2f }, { P::OSC2_SHAPE, 0 }, { P::OSC2_SEMITONE, 5 }, { P::OSC_RING, 0.4f },
            { P::OSC_MIX, 0.5f }, { P::FILT1_TYPE, 2 }, { P::FILT1_CUTOFF, 1200.0f }, { P::FILT1_RES, 0.5f },
            { P::AMPENV_A, 0.5f }, { P::AMPENV_S, 0.8f }, { P::AMPENV_R, 1.5f },
            { P::LFO1_RATE, 5.5f }, { P::ORBIT_MOTION, 0.6f }, { P::PHASER_ON, 1 }, { P::PHASER_MIX, 0.4f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.5f },
        }},
        { "Metallic FM Drone", "Experimental", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_SEMITONE, 6 }, { P::OSC_FM, 0.6f }, { P::OSC_MIX, 0.4f },
            { P::FILT1_TYPE, 2 }, { P::FILT1_CUTOFF, 2000.0f }, { P::FILT1_RES, 0.4f },
            { P::AMPENV_A, 2.0f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 3.0f },
            { P::DRIFT_AMOUNT, 0.6f }, { P::ORBIT_SPACE, 0.6f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.55f }, { P::REVERB_SIZE, 1.0f },
        }},
        { "Noise Riser FX", "FX", {
            { P::OSC1_SHAPE, 2 }, { P::OSC_NOISE, 0.5f }, { P::OSC_MIX, 0.0f },
            { P::FILT1_TYPE, 1 }, { P::FILT1_CUTOFF, 400.0f }, { P::FILT1_RES, 0.4f }, { P::FILT1_ENV_AMT, 0.9f },
            { P::FILTENV_A, 4.0f }, { P::FILTENV_S, 1.0f },
            { P::AMPENV_A, 2.0f }, { P::AMPENV_S, 0.9f }, { P::AMPENV_R, 1.0f },
            { P::ORBIT_SPACE, 0.6f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.5f }, { P::REVERB_SIZE, 1.0f },
        }},
        { "Glitch FM Bells", "Glitch", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_SEMITONE, 7 }, { P::OSC_FM, 0.5f }, { P::OSC_RING, 0.3f },
            { P::OSC_MIX, 0.4f }, { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 5000.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.3f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.2f },
            { P::ARP_ON, 1 }, { P::ARP_RATE, 7 }, { P::ARP_MODE, 5 }, { P::ARP_OCT, 2 }, { P::ARP_GATE, 0.4f },
            { P::CRUSH_ON, 1 }, { P::CRUSH_BITS, 7.0f }, { P::CRUSH_AMT, 0.4f }, { P::CRUSH_MIX, 0.5f },
            { P::DELAY_ON, 1 }, { P::DELAY_MIX, 0.35f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f },
        }},
        { "Detune Chaos Stab", "Experimental", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 3 }, { P::OSC2_FINE, 45.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 7 }, { P::UNISON_DETUNE, 0.8f }, { P::UNISON_SPREAD, 1.0f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 1800.0f }, { P::FILT1_RES, 0.3f },
            { P::AMPENV_A, 0.002f }, { P::AMPENV_D, 0.5f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.4f },
            { P::DRIFT_AMOUNT, 1.0f }, { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.4f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f },
        }},

        // ══ MORE GENRES II ════════════════════════════════════════════════════════
        { "Synthwave Lead II", "Synthwave", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 4 }, { P::OSC2_PW, 0.4f }, { P::OSC2_FINE, 6.0f }, { P::OSC_MIX, 0.45f },
            { P::UNISON_VOICES, 4 }, { P::UNISON_DETUNE, 0.3f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 2800.0f }, { P::FILT1_RES, 0.2f }, { P::FILT1_KEYTRACK, 0.4f },
            { P::AMPENV_A, 0.01f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 0.4f },
            { P::POLY_VOICES, 1 }, { P::GLIDE_TIME, 0.05f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.37f }, { P::DELAY_MIX, 0.3f }, { P::DELAY_FDBK, 0.4f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.3f }, { P::DRIFT_AMOUNT, 0.3f },
        }},
        { "Future Pluck Wide", "Future Bass", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, 8.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 5 }, { P::UNISON_DETUNE, 0.4f }, { P::UNISON_SPREAD, 1.0f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 2400.0f }, { P::FILT1_ENV_AMT, 0.4f },
            { P::FILTENV_A, 0.001f }, { P::FILTENV_D, 0.25f }, { P::FILTENV_S, 0.1f },
            { P::AMPENV_A, 0.002f }, { P::AMPENV_D, 0.5f }, { P::AMPENV_S, 0.2f }, { P::AMPENV_R, 0.4f },
            { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.4f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.35f },
            { P::VIBE_WIDE, 0.6f }, { P::VIBE_AIR, 0.3f },
        }},
        { "Lofi Bell Chime", "Lofi", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_FM, 0.2f }, { P::OSC_MIX, 0.3f },
            { P::FILT1_TYPE, 6 }, { P::FILT1_CUTOFF, 2200.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.8f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.6f },
            { P::DRIFT_AMOUNT, 0.7f }, { P::CRUSH_ON, 1 }, { P::CRUSH_BITS, 10.0f }, { P::CRUSH_AMT, 0.2f }, { P::CRUSH_MIX, 0.4f },
            { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.3f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f }, { P::EQ_ON, 1 }, { P::EQ_HIGH, -4.0f },
        }},
        { "Ambient Arp Bliss", "Arp", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_MIX, 0.35f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 2600.0f }, { P::FILT1_RES, 0.12f },
            { P::AMPENV_A, 0.01f }, { P::AMPENV_D, 0.5f }, { P::AMPENV_S, 0.2f }, { P::AMPENV_R, 0.6f },
            { P::ARP_ON, 1 }, { P::ARP_RATE, 5 }, { P::ARP_MODE, 2 }, { P::ARP_OCT, 2 }, { P::ARP_GATE, 0.55f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.375f }, { P::DELAY_FDBK, 0.5f }, { P::DELAY_MIX, 0.35f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.5f }, { P::REVERB_SIZE, 0.95f }, { P::VIBE_DREAM, 0.5f },
        }},
        { "Trap Pluck Wide", "Trap", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC2_FINE, 5.0f }, { P::OSC_MIX, 0.35f },
            { P::UNISON_VOICES, 3 }, { P::UNISON_DETUNE, 0.25f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 3000.0f }, { P::FILT1_ENV_AMT, 0.3f },
            { P::FILTENV_D, 0.2f }, { P::FILTENV_S, 0.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.5f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.4f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.3f }, { P::DELAY_MIX, 0.3f }, { P::DELAY_FDBK, 0.45f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.4f }, { P::VIBE_WIDE, 0.5f },
        }},
        { "Organ Vibrato", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::SUB_LEVEL, 0.25f }, { P::OSC_MIX, 0.5f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 4000.0f },
            { P::AMPENV_A, 0.005f }, { P::AMPENV_S, 0.95f }, { P::AMPENV_R, 0.15f },
            { P::LFO1_RATE, 5.5f }, { P::VIBE_MOVE, 0.3f },
            { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.4f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.3f },
        }},
        { "Deep Tech Stab", "Techno", {
            { P::OSC1_SHAPE, 3 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, -6.0f }, { P::OSC_MIX, 0.45f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 1300.0f }, { P::FILT1_RES, 0.35f }, { P::FILT1_ENV_AMT, 0.3f },
            { P::AMPENV_A, 0.002f }, { P::AMPENV_D, 0.3f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.2f },
            { P::CHORD_ON, 1 }, { P::CHORD_TYPE, 1 /*Minor*/ },
            { P::DRIVE_ON, 1 }, { P::DRIVE_AMOUNT, 0.3f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.25f }, { P::DELAY_ON, 1 }, { P::DELAY_MIX, 0.2f },
        }},
        { "Hopeful Maj Pad", "Pad", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC2_FINE, 4.0f }, { P::OSC_MIX, 0.4f },
            { P::UNISON_VOICES, 4 }, { P::UNISON_DETUNE, 0.3f }, { P::UNISON_SPREAD, 0.9f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 2800.0f }, { P::FILT1_RES, 0.1f },
            { P::AMPENV_A, 0.5f }, { P::AMPENV_D, 0.8f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 2.0f },
            { P::CHORD_ON, 1 }, { P::CHORD_TYPE, 11 /*Maj9*/ },
            { P::CHORUS_ON, 1 }, { P::CHORUS_MIX, 0.35f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.45f }, { P::VIBE_DREAM, 0.4f }, { P::VIBE_AIR, 0.4f },
        }},
        { "Plucked FM Keys", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_OCTAVE, 1 }, { P::OSC_FM, 0.3f }, { P::OSC_MIX, 0.3f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 3500.0f }, { P::FILT1_ENV_AMT, 0.25f }, { P::FILT1_KEYTRACK, 0.4f },
            { P::FILTENV_D, 0.3f }, { P::FILTENV_S, 0.1f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.6f }, { P::AMPENV_S, 0.15f }, { P::AMPENV_R, 0.4f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.28f }, { P::DELAY_MIX, 0.25f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.3f }, { P::DRIFT_AMOUNT, 0.25f },
        }},
        { "Warm Brass Pad", "Pad", {
            { P::OSC1_SHAPE, 2 }, { P::OSC2_SHAPE, 2 }, { P::OSC2_FINE, 5.0f }, { P::OSC_MIX, 0.5f },
            { P::UNISON_VOICES, 4 }, { P::UNISON_DETUNE, 0.3f },
            { P::FILT1_TYPE, 4 }, { P::FILT1_CUTOFF, 1600.0f }, { P::FILT1_RES, 0.15f }, { P::FILT1_ENV_AMT, 0.35f },
            { P::FILTENV_A, 0.3f }, { P::FILTENV_D, 0.6f }, { P::FILTENV_S, 0.6f },
            { P::AMPENV_A, 0.2f }, { P::AMPENV_D, 0.6f }, { P::AMPENV_S, 0.85f }, { P::AMPENV_R, 1.0f },
            { P::DRIFT_AMOUNT, 0.35f }, { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.35f }, { P::VIBE_WARM, 0.4f },
        }},
        { "Plinky Music Box", "Keys", {
            { P::OSC1_SHAPE, 0 }, { P::OSC2_SHAPE, 0 }, { P::OSC2_SEMITONE, 12 }, { P::OSC_MIX, 0.3f },
            { P::FILT1_TYPE, 0 }, { P::FILT1_CUTOFF, 5500.0f },
            { P::AMPENV_A, 0.001f }, { P::AMPENV_D, 0.9f }, { P::AMPENV_S, 0.0f }, { P::AMPENV_R, 0.6f },
            { P::DELAY_ON, 1 }, { P::DELAY_TIME, 0.33f }, { P::DELAY_FDBK, 0.4f }, { P::DELAY_MIX, 0.3f },
            { P::REVERB_ON, 1 }, { P::REVERB_MIX, 0.45f }, { P::REVERB_SIZE, 0.85f }, { P::VIBE_DREAM, 0.4f },
        }},
    };
    return bank;
}
